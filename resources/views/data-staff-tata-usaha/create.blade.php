...
@section('title', 'Tambah tata usaha')
...
@section('content')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Data Staff Tata Usaha</h3>
    ...
    <div class="page-content">
        <!-- Form tambah data staff tata usaha -->
        <div class="card">
            <div class="card-body">
                <form action="{{ route('staff-tata-usaha.store') }}" method="POST">
                    @csrf
                    @if ($errors->any())
        ...
        <!-- End Form tambah data staff tata usaha -->
    </div>
@endsection
